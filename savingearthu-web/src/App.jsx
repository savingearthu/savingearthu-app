      ...
      >
        ...
        <div style={{ padding:"6px 20px 48px" }}>
          ...
          <div style={{ display:"flex", gap:8, marginBottom:22 }}>
            {STATS.map((s,i) => (
              <div key={i} style={{ flex:1, background:"#f0faf4", borderRadius:14, padding:"14px 4px", textAlign:"center" }}>
                ...
                <p style={{ fontSize:20, fontWeight:800, color:GREEN }}>{s.value}</p>
                <p style={{ fontSize:12, color:"#bbb" }}>{s.unit}</p>
          ...
          <div style={{ marginBottom:22 }}>
              ...
              {FLOW_ROW1.map((f, i) => (
                <div key={i} style={{ display:"flex", alignItems:"center", flex:1 }}>
                  <div style={{ flex:1, background:"#f0f9ff", borderRadius:10, padding:"10px 2px", textAlign:"center" }}>
                    ...
                    <p style={{ fontSize:11, color:"#0a6a8a" }}>{f.label}</p>
                  </div>
            ...
            {/* 2행: 2개 - 왼쪽 정렬로 첫번째 아이템 아래에서 이어지게 */}
            <div style={{ display:"flex", alignItems:"center", gap:2 }}>
              ...
              {/* 전달 */}
              <div style={{ flex:1 }}>
                <div style={{ background:"#f0f9ff", borderRadius:10, padding:"10px 2px", textAlign:"center" }}>
                  <span className="material-symbols-outlined" style={{ fontSize:20, color:BLUE, display:"block", marginBottom:4 }}>{FLOW_ROW2[1].icon}</span>
                  <p style={{ fontSize:11, color:"#0a6a8a" }}>{FLOW_ROW2[1].label}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ display:"flex", borderRadius:14, overflow:"hidden", border:"1px solid #eef2f8", marginBottom:22 }}>
            <div style={{ flex:1, background:"#f7fafe" }}>
              <img src={TEACHER_IMG} alt="황무연 선생님"
              ...
              <div style={{ padding:"12px 10px 14px", textAlign:"center" }}>
                ...
                <a href={INTERVIEW_URL} target="_blank" rel="noreferrer"
                  style={{ fontSize:11, fontWeight:700, color:BLUE, textDecoration:"none" }}>이야기 들으러가기 →</a>
              </div>
            </div>
            <div style={{ width:1, background:"#e8eef8", flexShrink:0 }}/>
            <div style={{ flex:1, background:"#f7fafe" }}>
              <img src={RECYCLE_IMG} alt="종이팩 다시쓰기"
              ...
              <div style={{ padding:"12px 10px 14px", textAlign:"center" }}>
                ...
                <a href={RECYCLE_URL} target="_blank" rel="noreferrer"
                  style={{ fontSize:11, fontWeight:700, color:BLUE, textDecoration:"none" }}>활동 보러가기 →</a>
              </div>
            </div>
          </div>
